...
public final class WindsweptFoods {
    ...
    public static final FoodProperties GINGERBREAD_COOKIE = new FoodProperties.Builder().nutrition(2).fast().saturationModifier(.1f).effect(() -> new MobEffectInstance(WindsweptEffects.PLENTY, 200, 0), 1f).build();
